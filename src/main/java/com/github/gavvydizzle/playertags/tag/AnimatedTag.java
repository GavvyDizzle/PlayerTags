...
public class AnimatedTag extends Tag {
    ...
    public AnimatedTag(@NotNull String id, @NotNull ItemStack unlockedItem, @NotNull ItemStack lockedItem, boolean hidden, @NotNull List<String> tags, int updateIntervalMillis) {
