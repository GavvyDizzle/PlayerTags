...
import com.github.gavvydizzle.playertags.commands.admin.AdminHelpCommand;
...
import com.github.gavvydizzle.playertags.configs.CommandsConfig;
...
public class AdminCommandManager implements TabExecutor {
    ...
    public AdminCommandManager(PluginCommand command, TagsManager tagsManager) {
        ...
        subcommands.add(new ReloadCommand(this, tagsManager));
        subcommands.add(new RemoveTagCommand(this, tagsManager));
        subcommands.add(new SetTagCommand(this, tagsManager));
    ...
    public void reload() {
        ...
        config.addDefault("commandDisplayName.admin", command.getName());
        config.addDefault("helpCommandPadding.admin", "&6-----(({page}/{max_page}) " + PlayerTags.getInstance().getName() + " Admin Commands)-----");
